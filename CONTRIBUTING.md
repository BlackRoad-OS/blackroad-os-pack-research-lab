# Contributing to blackroad-os-pack-research-lab
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-pack-research-lab.git
cd blackroad-os-pack-research-lab

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-pack-research-lab.git
